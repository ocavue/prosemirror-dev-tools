...
var ListItem = (0, _styled["default"])("div")({
  ...
  border: "none",
  borderTop: "1px solid ".concat(_theme["default"].main20),
  margin: 0,
  "&:first-child": {
    borderTop: "none"
  },
  ...
  return {
    ...
    background: props.background ? props.background(props) : props.isSelected ? _theme["default"].main40 : "transparent"
  };
});
exports.ListItem = ListItem;
ListItem.displayName = "ListItem";
var ListItemGroupContent = (0, _styled["default"])("div")({
  display: "block"
}, function (props) {
  return {
...
var ListItemGroup = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(ListItemGroup, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement(ListItem, {
        key: getKey(items[0]),
      ...
      }, groupTitle(items, 0)), /*#__PURE__*/_react["default"].createElement("div", null, this.state.collapsed ? "▶" : "▼")), /*#__PURE__*/_react["default"].createElement(ListItemGroupContent, {
        collapsed: this.state.collapsed
...
function List(props) {
  ...
  return /*#__PURE__*/_react["default"].createElement("div", null, (props.items || []).map(function (item, index) {
    if (Array.isArray(item)) {
      return /*#__PURE__*/_react["default"].createElement(ListItemGroup, _extends({}, props, {
        items: item,
